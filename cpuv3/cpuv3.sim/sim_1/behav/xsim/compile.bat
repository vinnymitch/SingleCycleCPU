...
REM
REM Generated by Vivado on Wed May 11 21:09:40 -0500 2022
...
echo "xvlog --incr --relax -L uvm -prj cpuTB_vlog.prj"
call xvlog  --incr --relax -L uvm -prj cpuTB_vlog.prj -log xvlog.log
